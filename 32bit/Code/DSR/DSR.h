...
#define _SOM_CLUSTERING	
#define CLUSTER_INTERVAL 5*SECOND

/*****************Uncomment this to run som Clustering instead of DSR **********************
If som Clustering is enabled in WSN, instead of running DSR clustering is used. The som Clustering 
Codes are  available in som_Clustering.c. Please read that file for implementation specifics
Cluster heads are somally selected for each cluster based on sensor energy
